...
- FILEMAP.md — este arquivo (mapa detalhado do repositório).
...
- **init**.py
- main.py — inicializa FastAPI, configura CORS, monta `StaticFiles` (/hls, /clips), inclue routers, carrega modelos no startup e loga valores de config.
