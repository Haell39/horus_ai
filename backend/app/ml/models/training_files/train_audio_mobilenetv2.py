#!/usr/bin/env python3
"""Treino MobileNetV2 - Áudio (espectrogramas como imagens)
...
def get_augmentation():
    # For spectrograms, milder augmentation
...
def main():
    ...
    summary_path = 'outputs/results/training_summary_phase2_audio.txt'
    history_json = 'outputs/results/training_history_audio.json'
    history_png = 'outputs/results/training_history_audio.png'
    ...
    try:
        ...
        # create augmentation once and integrate into the model
        ...
        print('Treino (audio) finalizado com sucesso. Resumo salvo em', summary_path)
        ...
        print('Erro durante o dry-run audio. Ver', summary_path)
